    ...
    return(
        <>
            <div key={event.eventId} className="card custom-bg mt-3">
                ...
                <p className="card-text"><i className="me-md-3 fa-regular fa-clock"></i>{event.date}</p>
                <p className="card-text"><i className="me-md-3 fa-solid fa-earth-americas"></i>{event.city} | {event.placeVenue}</p>
                <p className="card-text"><i className="me-md-3 fa-solid fa-circle-info"></i>{event.details}</p>
